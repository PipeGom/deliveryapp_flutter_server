...
const storage = new Storage({
    projectId: "delivery-app-ea504", /// Proviene de Fire Base 
    keyFilename: './serviceAccountKey.json' // Proviene de fire base
});

const bucket = storage.bucket("gs://delivery-app-ea504.appspot.com/"); // Viene de Fire base
